...
bool EliteOrc::Initialise(Renderer& renderer) {
    ...
    m_orcWalk = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Elite Orc/Elite Orc/Elite Orc-Walk.png");
    if (m_orcWalk) {
    ...
    m_orcHurt = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Elite Orc/Elite Orc/Elite Orc-Hurt.png");
    if (m_orcHurt) {
    ...
    m_orcDeath = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Elite Orc/Elite Orc/Elite Orc-Death.png");
    if (m_orcDeath) {
    ...
    m_orcAttack1 = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Elite Orc/Elite Orc/Elite Orc-Attack01.png");
    if (m_orcAttack1) {
    ...
    m_orcAttack2 = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Elite Orc/Elite Orc/Elite Orc-Attack02.png");
    if (m_orcAttack2) {
