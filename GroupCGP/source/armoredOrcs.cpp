...
bool ArmoredOrc::Initialise(Renderer& renderer) {
    ...
    LogManager::GetInstance().Log("Initializing ArmoredOrc sprites...");

    //Load orc's idle sprite
    m_orcIdle = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Armored Orc/Armored Orc/Armored Orc-Idle.png");
    if (m_orcIdle) {
    ...
    m_orcWalk = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Armored Orc/Armored Orc/Armored Orc-Walk.png");
    if (m_orcWalk) {
    ...
    m_orcHurt = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Armored Orc/Armored Orc/Armored Orc-Hurt.png");
    if (m_orcHurt) {
    ...
    m_orcDeath = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Armored Orc/Armored Orc/Armored Orc-Death.png");
    if (m_orcDeath) {
    ...
    m_orcAttack1 = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Armored Orc/Armored Orc/Armored Orc-Attack01.png");
    if (m_orcAttack1) {
    ...
    m_orcAttack2 = renderer.CreateAnimatedSprite("../game/assets/Sprites/Orcs/Armored Orc/Armored Orc/Armored Orc-Attack03.png");
    if (m_orcAttack2) {
